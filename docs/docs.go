            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.AlertListResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.alertInput"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.AlertResponse"
                        }
                    },
                    "400": {
        ...
        "/alerts/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated alert criteria",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.StartConversationRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.MessageResp"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.FavoriteToggleResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/properties": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Property type (Apartment, Studio, Bedsitter…)",
                        "name": "property_type",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.PropertyListResponse"
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Bedsitter | Studio | Apartment | Maisonette | Bungalow | Townhouse | Villa | Commercial",
                        "name": "property_type",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "file",
                        "description": "Property images (multiple)",
                        "name": "images",
                        "in": "formData"
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.PropertyResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.PropertyImageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.RentalListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.RentalResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateRentalStatusRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.SearchHistoryResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/handlers.SaveSearchHistoryRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdatePushTokenRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.CreateReviewRequest": {
            ...
            "properties": {
                "comment": {
                    "type": "string",
                    "example": "Great location and very clean."
                },
                "rating": {
                    "type": "integer",
                    "maximum": 5,
        ...
        "handlers.FavoriteToggleResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/handlers.FavoriteToggleData"
                },
                "success": {
                    "type": "boolean",
                    "example": true
        ...
        "handlers.PropertyImageResponse": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "handlers.SaveSearchHistoryRequest": {
            "type": "object",
            "properties": {
                "search_term": {
                    "type": "string",
                    "example": "apartment Douala"
                }
            }
        },
        "handlers.SearchHistoryResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "handlers.SendMessageRequest": {
            ...
            "properties": {
                "content": {
                    "type": "string",
                    "example": "Hello, I am interested in renting this property."
                }
            }
        },
        "handlers.StartConversationRequest": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
        ...
        "handlers.UpdatePushTokenRequest": {
            "type": "object",
            "properties": {
                "expo_push_token": {
                    "type": "string",
        ...
        "handlers.UpdateRentalStatusRequest": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string",
        ...
        "models.Alert": {
            ...
            "properties": {
                ...
                "country": {
                    "description": "Location filters (all optional — empty means \"any\")",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
        ...
        "models.Property": {
            ...
            "properties": {
                ...
                "country": {
                    "description": "Location — from broad to precise",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "neighborhood": {
                    "description": "sub-area within the city (optional)",
                    "type": "string"
                },
                "owner": {
                ...
                "state": {
                    "description": "state / county / region / province (optional)",
                    "type": "string"
                },
                "surface": {
                    "description": "m²",
        ...
        "models.Rental": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "pending, occupied, available, completed",
                    "type": "string"
                },
                "tenant": {
                    "$ref": "#/definitions/models.User"
